...
import numpy as np
import miditoolkit
import processing.modules as modules
import pickle
import processing.utils as utils
import time

class NotezartTransformer(object):
    ########################################
    # initialize
    ########################################
    ...
    # load model
    ########################################
    def load_model(self, existing_model=None):
    ...
    ########################################
    def prepare_data(self, all_events):
        # event to word
        all_words = []
    ...
    # finetune
    ########################################
    def finetune(self, epochs, training_data, output_checkpoint_folder):
        # shuffle
